...
|Internal reference number of this OGC(R) document: YY-NNN
|Version:
...
|===
|*Copyright notice*
|Copyright (C) YYYY Open Geospatial Consortium
...
This OGC Response to Comments document provides detailed responses to each of the comments received during the <Technical Committee 45-day electronic voting period> <Public Comment period>.
