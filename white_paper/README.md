...
`docker run -v "$(pwd)":/metanorma metanorma/metanorma  metanorma new -d white-paper -t ogc  -l https://github.com/metanorma/metanorma-templates-ogc folder_for_white_paper`
