...
`docker run --rm -v "$(pwd)":/metanorma metanorma/metanorma  metanorma new -d engineering-report -t ogc  -l https://github.com/metanorma/metanorma-templates-ogc folder_for_engineering_report`
