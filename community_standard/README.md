...
`docker run --rm -v "$(pwd)":/metanorma metanorma/metanorma  metanorma new -d community-standard -t ogc  -l https://github.com/metanorma/metanorma-templates-ogc folder_for_community_standard`
