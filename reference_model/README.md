...
`docker run --rm -v "$(pwd)":/metanorma metanorma/metanorma  metanorma new -d reference-model -t ogc  -l https://github.com/metanorma/metanorma-templates-ogc folder_for_reference_model`
