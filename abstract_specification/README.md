# Abstract Specification Topic template
...
**Step 1**. Obtain the template for a Draft Abstract Specification Topic from the `template` sub-folder.
...
**Step 3**. Ensure that the `doctype` property is set to `abstract-specification-topic`.
...
### Compiling a Draft Abstract Specification Topic with a local Metanorma instance
...
### Compiling a Draft Abstract Specification Topic with a docker-containerized Metanorma instance
